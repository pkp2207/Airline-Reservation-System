...
public:
	...
	Flight(string dest, int num, string date, int dur, float pr) : destination(dest), flightNumber(num), departureDate(date), duration(dur), price(pr) {}

	virtual void GetFlightDetails()
	{
...
{
public:
	DubaiFlight() : Flight("Dubai", 498, "08-01-2022 8:00 AM", 10, 14000) {}

	void GetFlightDetails() override
	{
...
{
public:
	CanadaFlight() : Flight("Canada", 198, "09-01-2022 2:00 PM", 20, 34000) {}
